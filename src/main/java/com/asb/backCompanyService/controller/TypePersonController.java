...
@RestController
@RequestMapping("/${app.request.prefix}/${app.request.version}${app.request.mappings}/type-person")
@CrossOrigin(origins = "*", methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE})
@RequiredArgsConstructor(onConstructor_ = @Autowired)
@Slf4j
public class TypePersonController {

    private final TypePersonBusiness typePersonBusiness;
    ...
    public ResponseEntity<List<TypePerson>> getAll() {
        ...
        List<TypePerson> cities = typePersonBusiness.getAll();
