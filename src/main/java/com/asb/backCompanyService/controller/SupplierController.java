...
public class SupplierController {
    ...
    @DeleteMapping("/products/delete/{supplierProductId}")
    public ResponseEntity<GenericResponse> deleteSupplierProductLogical(@PathVariable("supplierProductId")Long supplierProductId) {
