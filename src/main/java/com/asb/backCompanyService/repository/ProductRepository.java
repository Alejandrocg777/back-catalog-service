...
public interface ProductRepository extends CrudRepository<Product, Long> {
    ...
    @Query(value = "SELECT new com.asb.backCompanyService.dto.responde.ProductResponseDTO(c.id, c.productName, c.price, c.description,c.categoryId, a.nameCategory, c.quantity, c.imgProduct, c.status, c.statusProduct) " +
            "FROM Product c " +
    ...
    @Query(value = "SELECT new com.asb.backCompanyService.dto.responde.ProductResponseDTO(c.id, c.productName, c.price, c.description,c.categoryId, a.nameCategory, c.quantity, c.imgProduct, c.status, c.statusProduct) " +
            ...
            countQuery = "SELECT COUNT(*) " +
                    ...
                    "AND (:categoryName IS NULL OR UPPER(a.nameCategory) LIKE UPPER(:categoryName)) " +
                    "AND (:price IS NULL OR STR(c.price) LIKE UPPER(:price)) ")
    Page<ProductResponseDTO> search(String id, String quantity, String productName, String description, String categoryName, String price, Pageable pageable);
}
